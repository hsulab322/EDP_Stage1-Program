...
def search_folder(creds):
    ...
    try:
        ...
        while True:
            # pylint: disable=maybe-no-member
            response = service.files().list(q="mimeType='application/vnd.google-apps.folder' and name = 'Data'",
                                            spaces='Drive',
                                            corpora = 'drive',
...
# getFilebyID('1eaIy4icgb2CmVBjBCCj2M2_BFboVk_nR', creds)